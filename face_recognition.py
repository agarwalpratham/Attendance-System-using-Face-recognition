...
class Face_Recognition:
        def __init__(self,root):
            ...
            img_top=Image.open(r"images\mark_atten_1.jpg")
            img_top=img_top.resize((650,735),Image.ANTIALIAS)
            self.photoimg_top=ImageTk.PhotoImage(img_top)

            f_lbl=Label(self.root,image=self.photoimg_top)
            f_lbl.place(x=0,y=55,width=650,height=735)
            ...
            # button 
            b4_4=Button(f_lbl,text="Scan Face",command=self.face_recog,cursor="hand2",font=("times new roman",18,"bold"),bg="blue",fg="white")
            b4_4.place(x=365,y=620,width=200,height=40)

            # =========attendence==============

        def mark_attendance(self,i,r,n,d):
            with open("attendance_report/presence.csv","r+",newline="\n") as f:
